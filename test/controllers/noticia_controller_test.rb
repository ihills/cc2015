...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { fecha: @noticium.fecha, foto: @noticium.foto, id_noticia: @noticium.id_noticia, subtitulo: @noticium.subtitulo, texto: @noticium.texto, titulo: @noticium.titulo }
    end
  ...
  test "should update noticium" do
    patch :update, id: @noticium, noticium: { fecha: @noticium.fecha, foto: @noticium.foto, id_noticia: @noticium.id_noticia, subtitulo: @noticium.subtitulo, texto: @noticium.texto, titulo: @noticium.titulo }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
